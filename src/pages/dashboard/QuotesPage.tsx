    ...
    return (
      <div className="space-y-6 max-w-4xl">
        ...
        <div className="flex gap-2">
          <Button onClick={() => requireAuth(() => checkAndProceed(saveQuote))}><Save className="h-4 w-4 mr-1" /> Save</Button>
  ...
  return (
    ...
    <div className="space-y-6 flex-1 min-w-0">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => requireAuth(() => setEditing(emptyQuote()))}><Plus className="h-4 w-4 mr-1" /> New Quote</Button>
      </div>
      {quotes.length === 0 ? (
