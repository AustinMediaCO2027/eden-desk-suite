...
const InvoicePrint = forwardRef<HTMLDivElement, InvoicePrintProps>(
  ({
    ...
    return (
      <div ref={ref} style={pageStyle} data-print-template="invoice" data-template-style={templateStyle}>
        {preset.sidebar ? (
          <div
            aria-hidden="true"
            ...
            <tbody>
              <tr>
                ...
                <td style={{ width: "38%", textAlign: "right", verticalAlign: "top" }}>
                  <p style={{ margin: 0, fontSize: "7.2mm", fontWeight: preset.titleWeight, color: brandColor, letterSpacing: preset.titleLetterSpacing }}>INVOICE</p>
                  ...
                  {dueDate ? <p style={{ ...NUMERIC_RIGHT, margin: "1mm 0 0", fontSize: "3.1mm", color: "hsl(215 16% 47%)" }}>Due: {safeText(dueDate, 40)}</p> : null}
                </td>
              </tr>
            </tbody>
          </table>
