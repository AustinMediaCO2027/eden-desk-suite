        ...
        <div className="flex justify-between items-start mt-8 mb-2">
          ...
          <div className="flex gap-8 text-xs">
            <div>
              ...
              <span className="ml-3 text-gray-600">{date}</span>
            </div>
            {type === "invoice" && dueDate && (
              <div>
                ...
                <span className="ml-3 text-gray-600">{dueDate}</span>
              </div>
            )}
          </div>
        </div>
        ...
        <table className="w-full mb-6 text-sm">
          <thead>
            <tr className="border-b-2 border-gray-200">
              <th className="text-left py-2 px-2 font-semibold text-gray-500 text-xs w-8"></th>
              <th className="text-left py-2 px-2 font-semibold text-gray-500 text-xs">Description</th>
              <th className="text-center py-2 px-2 font-semibold text-gray-500 text-xs w-12">Qty</th>
              <th className="text-right py-2 px-2 font-semibold text-gray-500 text-xs w-24">Unit Price</th>
              <th className="text-right py-2 px-2 font-semibold text-gray-500 text-xs w-24">Amount</th>
            </tr>
          </thead>
          <tbody>
            {items.map((item, i) => (
