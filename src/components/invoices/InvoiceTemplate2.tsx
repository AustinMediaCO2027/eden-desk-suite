 ...
 * Matches Invoice_2.png: logo top-left, address top-right, blue metadata bar,
 * items table, Total due highlight bar, footer.
 */
const InvoiceTemplate2 = forwardRef<HTMLDivElement, InvoiceTemplateProps>(
  ({ profile, documentNumber, date, dueDate, clientName, clientEmail, clientAddress, items, taxRate, notes, colorOverride }, ref) => {
    ...
    return (
      <div ref={ref} style={PAGE} data-print-template="invoice" data-template-style="template2">
        {/* Header */}
        ...
        {/* Metadata bar – uses accent color */}
        <div style={{ backgroundColor: `${accent}12`, borderRadius: "2.5mm", padding: "3.5mm 5mm", marginBottom: "5mm" }}>
          <table style={T}>
            <tbody>
              <tr>
                <td style={{ width: "25%" }}>
                  <p style={{ margin: 0, fontSize: "2.5mm", color: "#888" }}>Due date</p>
                  <p style={{ margin: "0.8mm 0 0", fontSize: "3.1mm", fontWeight: 600 }}>{safeText(dueDate, 30)}</p>
                </td>
                <td style={{ width: "25%" }}>
                  <p style={{ margin: 0, fontSize: "2.5mm", color: "#888" }}>Invoice date</p>
                  <p style={{ margin: "0.8mm 0 0", fontSize: "3.1mm", fontWeight: 600 }}>{safeText(date, 30)}</p>
                </td>
                <td style={{ width: "25%" }}>
                  <p style={{ margin: 0, fontSize: "2.5mm", color: "#888" }}>Invoice number</p>
                  <p style={{ margin: "0.8mm 0 0", fontSize: "3.1mm", fontWeight: 600 }}>#{safeText(documentNumber, 30)}</p>
                </td>
                <td style={{ width: "25%", textAlign: "right" }}>
                  <p style={{ margin: 0, fontSize: "2.5mm", color: "#888" }}>Reference</p>
                  <p style={{ margin: "0.8mm 0 0", fontSize: "3.1mm", fontWeight: 600 }}>{safeText(documentNumber, 20)}</p>
                </td>
              </tr>
            </tbody>
          </table>
              ...
              <td style={{ width: "40%" }}>
                <div style={{ backgroundColor: accent, borderRadius: "2mm", padding: "3mm 4mm" }}>
                  <table style={{ width: "100%", borderCollapse: "collapse" }}>
                    <tbody><tr>
                      <td style={{ fontSize: "3.4mm", fontWeight: 700, color: "white", textAlign: "left" }}>Total due</td>
        ...
        <div style={{ position: "absolute", left: "20mm", right: "20mm", bottom: "20mm", borderTop: "0.3mm solid #e5e7eb", paddingTop: "3mm" }}>
          ...
          <table style={T}>
            <tbody>
              <tr>
                <td style={{ fontSize: "2.8mm", color: "#888" }}>Thank you for the business!</td>
